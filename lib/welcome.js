...
async function handleWelcome(sock, chatId, message, match) {
    ...
    if (lowerCommand === 'on') {
        ...
        await addWelcome(chatId, true, 'Welcome {user} to {group} السلام عليكم ورحمة الله وبركاته*'
...
'.........................................................'
'-----------------------------------------'
'🌺 May Allah bless our gathering and make it a source of' ' all of us Ameen 🌺'
'🌺ᴘᴏᴡᴇʀᴇᴅ ʙʏ Kazi md bot4X');
