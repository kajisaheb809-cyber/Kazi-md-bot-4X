#!/bin/bash
# Kazi-md-bot-4X Heroku One-Click Deployer
# Usage: bash <(curl -s https://raw.githubusercontent.com/kajisaheb809-cyber/Kazi-md-bot-4X/main/lib/heroku.sh)
...
# Session ID
read -p "$(echo -e ${CYAN}Session ID (Xchristech2/GAAJU-MD_xxxxx): ${NC})" SESSION_ID
...
# Bot name
read -p "$(echo -e ${CYAN}Bot name (default: GAAJU-MD): ${NC})" BOT_NAME
