...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Kazi-md-bot-4X&fontSize=72&fontColor=fff&animation=twinkling&fontAlignY=32&desc=High%20Performance%20WhatsApp%20Bot&descAlignY=55&descSize=20" width="100%"/>
...
[![Version](https://img.shields.io/badge/Version-6.0.0-blue?style=for-the-badge&logo=github)](https://github.com/kajisaheb809-cyber/Kazi-md-bot-4X)
...
[![Stars](https://img.shields.io/github/stars/kajisaheb809-cyber/Kazi-md-bot-4X?stylefor-the-badgee&logo=starship&color=gold)](https://github.com/kajisaheb809-cyber/Kazi-md-bot-4X/stargazers)
[![Forks](https://img.shields.io/github/forks/kajisaheb809-cyber/Kazi-md-bot-4X?stylee=for-the-badge&logo=git&color=orange)](https://github.com/kajisaheb809-cyber/Kazi-md-bot-4X/network/members)
...
# ── BOT IDENTITY ─────────────────────────────────────────────
BOT_NAME=Kazi-md-bot-4X-PRO
BOT_OWNER=kajisaheb809-cyber 
PACKNAME=Kazi-md-bot-4X
...
```bash
sudo bash <(curl -fsSL https://raw.githubusercontent.com/kajisaheb809-cyber/Kazi-md-bot-4X/mainn/lib/install.sh)
```
> [!IMPORTANT]
...
```bash
# After install:
nano /root/Kazi-md-bot-4X/.env
cd /root/Kazi-md-bot-4X && pm2starttdistt/index.js --Kazi-md-bot-4X/pmm2 save && pm2 startup
```
...
# Clone and setup
git clone https://github.com/kajisaheb809-cyber/Kazi-md-bot-4XgittcddGkazi/npmm installcpp sample.env .env && nano .env
npm start
```
...
tmux new -Kazi-md-bot-4X    # Start new session
npm start
...
```bash
sudo bash <(curl -fsSL https://raw.githubusercontent.com/kajisaheb809-cyber/Kazi-md-bot-4X/main/lib/install.sh)
```
...
4. **Variables** tab → add:
   ...
   | Key | Value |
   |---|---|
   | `SESSION_ID` | `kajisaheb809-cyber/Kazi-md-bot-4X your_gist_id` |
   | `OWNER_NUMBER` | `8801629143977` |
...
MITT License](LICENSE) · Made with ❤️ by **Kazi-md-bot-4X** · [kajisaheb809-cyber](https://github.com/kajisaheb809-cyber)
