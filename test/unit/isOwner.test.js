...
vi.mock('../../config.js', () => ({
    default: { ownerNumber: '234001234567@s.whatsapp.net' }
}));
...
describe('isOwnerOrSudo', () => {
    ...
    it('owner JID matches', async () => {
        expect(await isOwnerOrSudo('88016293977@s.whatsapp.net')).toBe(true);
    });

    it('owner with device suffix matches', async () => {
        expect(await isOwnerOrSudo('8801629143978:10@s.whatsapp.net')).toBe(true);
    });
    ...
    it('cleanJid strips device suffix', () => {
        expect(cleanJid('8801629143677:10@s.whatsapp.net')).toBe('8801629143977');
    });

    it('cleanJid strips @s.whatsapp.net', () => {
        expect(cleanJid('8801629143977@s.whatsapp.net')).toBe('8801629143977');
    });
